...
const Colors = () => {
    ...
    const [newColorForm, setNewColorForm] = useState({ content: '' });
    ...
    const deleteColor = useCallback(async (id) => {
        ...
        try {
            ...
            showToast(err.response?.data?.message || 'Failed to delete color', 'error');
            console.error('Delete color error:', err);
        } finally {
            setLoading(false);
        }
    }, [editingColor, showToast]);
    ...
    }, [user, isAuthLoading, navigate, fetchColors]);
    ...
    const handleNewFieldChange = useCallback((field, value) => {
        setNewColorForm(prev => ({ ...prev, [field]: value }));
    }, []);
        ...
        <div className="min-h-screen bg-gray-50 p-2 sm:p-3 lg:p-4 xl:p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 mb-4 lg:mb-6">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 lg:gap-4">
                    <div className="flex-1 min-w-0">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-1 lg:mb-2">Colors Management</h1>
                        <p className="text-gray-600 text-sm sm:text-base lg:text-lg">Manage product colors</p>
                    </div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-4 lg:mb-6" role="alert" aria-live="assertive">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            onClick={handleRetry}
                            aria-label="Retry loading colors"
                        >
                            Retry
                        </button>
                    </div>
            ...
            {loading && (
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-4 lg:mb-6" role="status" aria-live="polite">
                    <div className="flex flex-col items-center justify-center">
                        <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mb-4"></div>
                        <p className="text-gray-600 font-medium">Loading colors...</p>
                    </div>
                </div>
            )}
            ...
            {!loading && (
                <div className="space-y-4 lg:space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                        <div className="flex items-center justify-between">
                            <h2 className="text-lg font-semibold text-gray-900">Colors Management</h2>
                            <button
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8" role="status">
                            <div className="flex flex-col items-center justify-center space-y-4">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-500 text-sm">Get started by adding your first color</p>
                                </div>
                            </div>
                        </div>
                    ) : (
                                ...
                                <table className="w-full min-w-[600px]">
                                    <thead className="bg-gray-50 border-b border-gray-200">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Color Name</th>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h2 className="text-xl font-semibold text-gray-900">Add New Color</h2>
                            <button
                        ...
                        <div className="p-6">
                            <div className="space-y-4">
                                <div>
                                    <label htmlFor="create-color-name" className="block text-sm font-medium text-gray-700 mb-2">
                                        Color Name *
                                    </label>
                                    <input
                                        id="create-color-name"
                                        type="text"
                                        value={newColorForm.content}
                        ...
                        <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200">
                            ...
                            <button
                                ...
                                disabled={loading || !newColorForm.content}
                            >
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="p-6">
                            <div className="space-y-4">
                                <div>
                                    <label htmlFor="edit-color-name" className="block text-sm font-medium text-gray-700 mb-2">
                                        Color Name *
                                    </label>
                                    <input
                                        id="edit-color-name"
